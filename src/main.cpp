...
#include "Tabla.h"
#include "BD.h"
#include "ImportarTabla.h"
#include "InsertarEnTabla.h"
#include "EliminarEnTabla.h"
#include "EliminarTabla.h"
#include "Consultas.h"
#include "Enlace.h"

int main()
{
	//string com = introducirComando();
	...
	Columna c4("Nombre_produs", "char", 14, 4, registros3);
