...
//añadir remove, updata
//updata consiste en un nodo auxiliar, apuntara a los nodos que apuntaba el nodo removido y el que apuntaba al nodo a remober ahora apunta a auxiliar
//
